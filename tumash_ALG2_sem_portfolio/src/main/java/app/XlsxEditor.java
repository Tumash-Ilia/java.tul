...
public class XlsxEditor {
     ...
     * @throws IOException
     */
    public static List<Double> getProfitColumn() throws IOException {
     ...
     * @throws IOException
     */
    public static List<Double> geWalletProfit(String name) throws IOException {
        List<Double> list = new ArrayList<>();
        FileInputStream is = new FileInputStream(file);
        Workbook book = new XSSFWorkbook(is);
        Sheet sheet = book.getSheetAt(0);
     ...
     * @throws IOException
     */
    public static void addNewRow(String coin, int pos, int exchange, double minPrice, double maxPrice, int leverage, String wallet) throws IOException {
        List<Double> list = new ArrayList<>();
        FileInputStream is = new FileInputStream(file);
        Workbook book = new XSSFWorkbook(is);
        Sheet sheet = book.getSheetAt(0);
     ...
     * @throws IOException
     */
    public static void deleteRow(int index) throws IOException {
        FileInputStream is = new FileInputStream(file);
        Workbook book = new XSSFWorkbook(is);
        Sheet sheet = book.getSheetAt(0);
...
//        //  List<Double> list = geWalletProfit("BitMEX");
//        List<Double> list = getProfitColumn();
//        double sum = 0;
//        for (Double d : list) {
